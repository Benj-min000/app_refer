...
// Shows: store name, customer address, menu items, earnings, payment method, timer.
            ...
            child: Column(
              children: [
                    ...
                    builder: (_, __) => Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: AppTheme.primary
                            .withOpacity(0.1 + 0.12 * _pulse.value),
                      ),
                ...
                Row(children: [
                  ...
                  _StatChip(
                    icon: job.paymentMethod == 'CARD'
                        ? Icons.credit_card
                        : Icons.payments_outlined,
                    label: job.paymentMethod == 'CARD'
                        ? 'Card · Paid'
                        : 'Cash · zł${job.finalTotal?.toStringAsFixed(2) ?? '--'}',
                    color: job.paymentMethod == 'CARD'
                        ? AppTheme.primary
                        : AppTheme.warning,
                  ),
                  const SizedBox(width: 8),
                  _StatChip(
                    ...
                    label: '${job.items.length} item${job.items.length == 1 ? '' : 's'}',
                    color: AppTheme.info,
                  ),
                ]),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        _showItems ? 'Hide order items' : 'See order items',
                        style: const TextStyle(
